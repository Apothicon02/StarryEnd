...
public final class StarryEndBlocks {
    ...
    public static final RegistryObject<Block> ENDER_NEBULA_DUST = BLOCKS.register("ender_nebula_dust", () ->
            new ThinBlock(BlockBehaviour.Properties.of(Material.POWDER_SNOW, MaterialColor.COLOR_PURPLE).noCollission().instabreak().noOcclusion().strength(3.0F, 6.0F).isValidSpawn(Blocks::never).sound(SoundType.POWDER_SNOW)));
    public static final RegistryObject<Block> ENDER_NEBULA_DUST_BLOCK = BLOCKS.register("ender_nebula_dust_block", () ->
            new Block(BlockBehaviour.Properties.of(Material.SAND, MaterialColor.COLOR_PURPLE).strength(3.0F, 6.0F).isValidSpawn(Blocks::never).sound(SoundType.SAND)));
    ...
    public static final RegistryObject<Block> ENDER_PROTOSTAR_DUST = BLOCKS.register("ender_protostar_dust", () ->
            new ThinBlock(BlockBehaviour.Properties.of(Material.POWDER_SNOW, MaterialColor.COLOR_ORANGE).noCollission().instabreak().noOcclusion().strength(3.0F, 6.0F).isValidSpawn(Blocks::never).sound(SoundType.POWDER_SNOW)));
    public static final RegistryObject<Block> ENDER_PROTOSTAR_DUST_BLOCK = BLOCKS.register("ender_protostar_dust_block", () ->
            new Block(BlockBehaviour.Properties.of(Material.SAND, MaterialColor.COLOR_ORANGE).strength(3.0F, 6.0F).isValidSpawn(Blocks::never).sound(SoundType.SAND)));
    ...
    public static final RegistryObject<Block> ENDER_STAR_DUST = BLOCKS.register("ender_star_dust", () ->
            new ThinBlock(BlockBehaviour.Properties.of(Material.POWDER_SNOW, MaterialColor.COLOR_YELLOW).noCollission().instabreak().noOcclusion().strength(3.0F, 6.0F).isValidSpawn(Blocks::never).sound(SoundType.POWDER_SNOW)));
    public static final RegistryObject<Block> ENDER_STAR_DUST_BLOCK = BLOCKS.register("ender_star_dust_block", () ->
            new Block(BlockBehaviour.Properties.of(Material.SAND, MaterialColor.COLOR_YELLOW).strength(3.0F, 6.0F).isValidSpawn(Blocks::never).sound(SoundType.SAND)));
    ...
    public static final RegistryObject<Block> ENDER_NEUTRON_DUST = BLOCKS.register("ender_neutron_dust", () ->
            new ThinBlock(BlockBehaviour.Properties.of(Material.POWDER_SNOW, MaterialColor.COLOR_CYAN).noCollission().instabreak().noOcclusion().strength(3.0F, 6.0F).isValidSpawn(Blocks::never).sound(SoundType.POWDER_SNOW)));
    public static final RegistryObject<Block> ENDER_NEUTRON_DUST_BLOCK = BLOCKS.register("ender_neutron_dust_block", () ->
            new Block(BlockBehaviour.Properties.of(Material.SAND, MaterialColor.COLOR_CYAN).strength(3.0F, 6.0F).isValidSpawn(Blocks::never).sound(SoundType.SAND)));

    public static final RegistryObject<Block> SPODOSOL = BLOCKS.register("spodosol", () ->
            new SpodosolBlock(BlockBehaviour.Properties.copy(Blocks.PODZOL).sound(StarryEndSoundTypes.GRASSY_STONE).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> ENDER_TURF = BLOCKS.register("ender_turf", () ->
            new EnderTurfBlock(BlockBehaviour.Properties.copy(Blocks.PODZOL).sound(StarryEndSoundTypes.GRASSY_STONE).requiresCorrectToolForDrops()));
